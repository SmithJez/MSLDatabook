...
public class RecyclerViewFastScrollerWithBubble extends LinearLayout {
    ...
    public RecyclerViewFastScrollerWithBubble(final Context context, final AttributeSet attrs, final int defStyleAttr) {
        super(context, attrs, defStyleAttr);
        init(context);
    }

    public RecyclerViewFastScrollerWithBubble(final Context context) {
        super(context);
        init(context);
    }

    public RecyclerViewFastScrollerWithBubble(final Context context, final AttributeSet attrs) {
        super(context, attrs);
        init(context);
    }
